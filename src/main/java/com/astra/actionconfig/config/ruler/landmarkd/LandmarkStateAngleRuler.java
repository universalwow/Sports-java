...
import com.astra.actionconfig.config.data.landmarkd.LandmarkPosition;
import com.astra.actionconfig.config.data.state.WarningState;
import lombok.Data;

@Data
public class LandmarkStateAngleRuler {
    public String id = "";
    ...
    public LandmarkPosition fromLandmark;
    public LandmarkPosition toLandmark;
