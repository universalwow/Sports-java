...
//    public static List<Map<String,Double>> formatLandmarkList(List<Map<String,Double>> landmarks) {
//        List<Map<String,Double>> newLandmarks = new ArrayList<>();
//        // nose
//        newLandmarks.add(landmarks.get(0));
//
//
//        return  newLandmarks;
//
